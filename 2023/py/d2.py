def find_minimum_cubes(game_data):
    ...
    # Find the maximum number of each color of cubes shown at any one time
...
def calculate_power_of_games(input_data):
    # Parse the input data and store the games
    games = {}
    for line in input_data.split('\n'):
        if line.strip():
            ...
            for cube_set in cube_sets:
                ...
                games[game_id].append(cube_count)

    # Calculate the power of each game's minimum set of cubes
    total_power = 0
...
"""
# Process the games and get the sum of IDs of possible games

# Process the games and calculate the total power
print(calculate_power_of_games(input_data))
